                ...
                <div>
                  ...
                  <div className="px-4 py-6 flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                      <p className="text-charcoal text-sm font-medium">Tên</p>
                    ...
                    <div className="flex flex-col gap-2">
                      <p className="text-charcoal text-sm font-medium">Lớp</p>
                      <div className="border-2 mt-2 border-bright-gray rounded-full px-4 py-2.5 flex gap-2 items-center">
                        {/* <RsIcon type="glass" className="cursor-pointer" /> */}
                        {/* <input
                          type="password"
                          ...
                          className="bg-inherit border-none outline-none w-full"
                        /> */}
                        <select className="bg-inherit border-none outline-none w-full">
                          {Array(12)
                            .fill("")
                            .map((_, index) => (
